    ...
    return (
        <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-gray-400">
            ...
            <div className="flex items-center gap-4">
                {
                    token
                        ? <div  className='flex item-center gap2 cursor-pointer group relative'>
                            <img className='w-10 rounded-full' src={assets.profile_pic} alt="user" />
                            <img classNmae='w-2.5 'src={assets.dropdown_icon} alt="dropdown" />
